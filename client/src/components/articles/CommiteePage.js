...
//             <div className="member">Helianne Duke</div>
//             <div className="member">Clive Duke</div>
//             <div className="member">David Duke</div>
//             <div className="member">Elijah Duke</div>
//             <div className="member">Anna Duke</div>
//             <div className="member">Joshua Duke</div>
//             <div className="member">Rachel Duke</div>
//             <div className="member">Jediah Duke</div>
//           </div>
//         </div>
...
//             <div className="member">Dexter Edmund</div>
//             <div className="member">Elizabeth James</div>
//             <div className="member">Ed Osbourne</div>
//             <div className="member">Harriet George</div>
//             <div className="member">Catreena Holliday</div>
//             <div className="member">Deslyn Erahbor</div>
//             <div className="member">Abigail Joseph</div>
//             <div className="member">Ailene Stanislaus</div>
//             <div className="member">Milton Eastman</div>
//             <div className="member">Trevor Denoon</div>
//           </div>
//         </div>
//       </div>
//     </div>
...
//           <div className="hexagon-member">
//             <div className="hexagon-content">Dexter Edmund</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Elizabeth James</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Ed Osbourne</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Harriet George</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Catreena Holliday</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Deslyn Erahbor</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Abigail Joseph</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Ailene Stanislaus</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Milton Eastman</div>
//           </div>
//           <div className="hexagon-member">
//             <div className="hexagon-content">Trevor Denoon</div>
//           </div>
//         </div>
//       </div>
//     </div>
...
const Committee = () => {
  ...
  return (
    <div className="committee-container">
      <h1 className="committee-title">Committee</h1>
      <p style={{ color: "white" }}>
        The TobagoReads Committee is dedicated to ensuring the smooth operation
        and management of the charity home. It oversees financial planning,
        organizes community support initiatives, and ensures that residents
        receive proper care, education, and well-being. Through teamwork and
        dedication, the committee works to create a safe and supportive
